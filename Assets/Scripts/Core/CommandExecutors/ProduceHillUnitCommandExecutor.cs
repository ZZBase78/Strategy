...
{
    public class ProduceHillUnitCommandExecutor : CommandExecutorBase<IProduceHillUnitCommand>, IUnitProducer
    {
        ...
        public override async Task ExecuteSpecificCommand(IProduceHillUnitCommand command)
        {
            ...
            var mainBuilding = GetComponent<Embulance>();
