...
namespace Core
{
    public sealed class HillerCommandsQueue : MonoBehaviour, ICommandsQueue
    {
        ...
        [Inject] CommandExecutorBase<IHillCommand> _hillCommandExecutor;
        ...
        private async void ExecuteCommand(ICommand command)
        {
            ...
            await _hillCommandExecutor.TryExecuteCommand(command);
